...
import 'package:fitnessapp/view/home/widgets/bmi.dart';
//import 'package:fitnessapp/home/widgets/home_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      color: Color.fromRGBO(255, 199, 199, 1.0),
                        onPressed: () {
                                    ...
                                    child: GestureDetector( onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => BMICalculator()
                                       ...
                                       child:  Container(
                                         ...
                                         decoration: BoxDecoration(
                                           gradient: LinearGradient(
                                             colors: [Color(0xFFE96BF4), Color(0xFFFFC7C7)],
                                           ),
                                      ...
                                      // Container(
                                        //
                                        //     child: Text("Click here to find your B.M.I"),
                                        //
                                        //     height: 90,
                                        //   width: 80,
                                        //   decoration: BoxDecoration(
  ...
  List<PieChartSectionData> showingSections() {
    return List.generate(
      2,
      (i) {
        const color0 = Color.fromRGBO(249, 161, 255, 0.8156862745098039);
        const color1 = Color.fromRGBO(7, 30, 61, 1.0);
